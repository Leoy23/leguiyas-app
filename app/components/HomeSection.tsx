        ...
        <section className='max-w-full'>
            <div className='flex justify-between'>
                <div className='w-full flex justify-center'>
                    <Image src={logoText2} alt="" className='flex-shrink-0 md:static md:w-full' height={300} priority />
                </div>
                <div className='flex justify-center'>
                    <SocialMedia />
                </div>
            </div>
            <div> <Image src={leguiyaMobile} alt='leguiya mobile' className='min-[426px]:hidden' />
                <Image src={leguiyaDesktop} alt='leguiya desktop image' priority className='hidden min-[426px]:block min-[426px]:w-full' /></div>
